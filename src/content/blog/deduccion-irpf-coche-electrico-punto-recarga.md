---
title: "Deducción IRPF por comprar un eléctrico o instalar el punto de recarga"
...
## Deducción por instalar el punto de recarga
...
No es automática: se aplica en la declaración de la renta del ejercicio en que hiciste la compra o la instalación, dentro del apartado de deducciones. Necesitarás guardar la factura de compra del vehículo (o de la instalación del punto de recarga) con el desglose del precio, y el justificante de cualquier ayuda pública recibida para restarla de la base antes de calcular el 15 %.
...
Esta deducción es fiscal (se aplica en la renta del año siguiente) y compatible con la ayuda directa del Plan Auto+ (que se descuenta en el momento de la compra) y con las ayudas autonómicas de tu comunidad, si las hay. El resumen completo de cómo se combinan todas estas ayudas está en [Plan Auto+ (antes MOVES): ayudas para coche eléctrico](/plan-moves-ayudas-coche-electrico/) y en [ayudas autonómicas para coche eléctrico](/ayudas-autonomicas-coche-electrico-ccaa/).

## Preguntas frecuentes

**¿Puedo aplicar esta deducción si compré el coche de segunda mano?**
No: la deducción por adquisición de vehículo exige que sea nuevo. Si compras de segunda mano, no aplica esta deducción concreta.

**¿Tengo que elegir entre la deducción del coche y la del punto de recarga?**
No, son independientes y acumulables si hiciste ambas cosas, cada una con su propio límite de base.

**¿Qué pasa si el coche lo compra mi empresa, no yo como particular?**
Esta deducción concreta del IRPF es para particulares; si el vehículo está afecto a una actividad económica, autónomos y empresas tienen otro tratamiento fiscal distinto (amortización, IVA deducible, etc.), que conviene consultar con un asesor.
