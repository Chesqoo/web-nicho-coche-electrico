---
title: "Plan Auto+ (antes MOVES): ayudas para coche eléctrico en 2026"
...
## Qué es el Plan Auto+ y en qué se diferencia de MOVES

El Plan Auto+ tiene un presupuesto de 400 millones de euros para 2026: 350 millones para particulares, 42 millones para pequeñas empresas (hasta 10 trabajadores) y 8 millones para autónomos. La diferencia práctica más importante frente a MOVES: el descuento se aplica directamente en el concesionario en el momento de la compra, en vez de tener que adelantar el dinero y esperar meses al reembolso.

## Cuánto dan: el sistema EEE

La ayuda no es una cifra fija — se calcula sumando tres criterios acumulables, cada uno como un porcentaje de la ayuda máxima (4.500 € para un turismo particular):

| Criterio | Condición | % de la ayuda máxima |
|---|---|---|
| Eléctrico | Vehículo 100% eléctrico (BEV) | 50 % (2.250 €) |
| Eléctrico | Híbrido enchufable (PHEV) con más de 40 km de autonomía eléctrica | 25 % (1.125 €) |
| Económico | Precio de factura sin impuestos por debajo de 35.000 € | 25 % (1.125 €) |
| Económico | Precio de factura sin impuestos entre 35.000 € y 45.000 € | 15 % (675 €) |
| Europeo | Montaje final del vehículo en la Unión Europea | 15 % (675 €) |
| Europeo | Batería también ensamblada en la Unión Europea | 10 % (450 €) |

Por ejemplo, un eléctrico puro de menos de 35.000 € montado en la UE con batería europea suma 2.250 + 1.125 + 675 + 450 = 4.500 €, la ayuda máxima. Un PHEV del mismo precio pero sin producción europea se quedaría en 1.125 + 1.125 = 2.250 €. Para furgonetas y motos las cuantías máximas cambian (ver más abajo), pero el mismo sistema de criterios acumulables aplica.

- **Coche eléctrico particular**: hasta 4.500 €.
- **Autónomos y pequeñas empresas**: hasta 6.000 € por coche eléctrico.
- **Furgonetas**: hasta 5.000 € (particulares) o 7.500 € (autónomos/empresas).
- **Motos y cuadriciclos eléctricos**: entre 1.100 € y 1.500 €.

Además, esta ayuda directa es compatible con la deducción del 15 % en el IRPF sobre el valor de compra (hasta un límite de base), que se solicita aparte en la declaración de la renta — aunque su continuidad más allá de 2026 está en duda, como explicamos en [deducción IRPF por comprar un eléctrico o instalar el punto de recarga](/deduccion-irpf-coche-electrico-punto-recarga/).
...
- **Exención del impuesto de matriculación** por tener 0 emisiones oficiales.
...
No para solicitudes nuevas: ha sido sustituido por el Plan Auto+. Si tenías una solicitud de MOVES III ya presentada y aprobada, se sigue tramitando con sus propias reglas; consulta tu expediente en el portal de tu comunidad autónoma.

**¿Puedo combinar la ayuda del Plan Auto+ con un descuento del concesionario?**
Sí, normalmente son conceptos independientes, pero pregunta siempre si el precio final que te ofrecen ya incluye o no la ayuda estatal aplicada.

**¿Los coches híbridos enchufables también reciben esta ayuda?**
Sí, pero con requisitos y cuantía menor: necesitan distintivo CERO (más de 40 km de autonomía eléctrica homologada) y el criterio "eléctrico" del sistema EEE les da solo el 25 % de la ayuda máxima, frente al 50 % de un eléctrico puro — ver la tabla de arriba.

## Fuentes

- [Programa Auto+ — Ministerio de Industria y Turismo](https://www.mintur.gob.es/es-es/programa-auto/)
